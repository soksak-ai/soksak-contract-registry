...
current release reference per plugin and copies no runtime dependencies; a reader walks the closure
from each release document. Component details remain in immutable owner releases.
